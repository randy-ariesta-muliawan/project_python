...
cursor_turret = pg.image.load('img/dart monkey.png').convert_alpha()
#enemies
enemy_image = pg.image.load('img/Better_Red.png').convert_alpha()
#buttons
...
with open('img/levels.tmj') as file:
