...
class Enemy:
	...
	def hit(self,damage):
		player.money+=1
		self.health -= damage
		shot_fx = pygame.mixer.Sound('sounds/pop1.mp3')
		shot_fx.play()
		if self.health<=0:
...
def dispText(screen,wavenum):
	font = pygame.font.Font('ar-christy-cufonfonts/ARCHRISTY.ttf',18)
	h = font.get_height()+2
...
def main():
	...
	background = pygame.Surface((800,750)); background.set_colorkey((0,0,0))
